    ...
    <div className="product flex flex-col gap-2 bg-white shadow-lg rounded-xl overflow-hidden ">
      ...
      <div className="texts flex flex-col gap-2 px-5 pb-5">
        ...
        <div className="flex justify-between items-center ">
          ...
          <button onClick={()=>addTocartHandler(product.id)} className="btn uppercase bg-teal-500 text-teal-50 px-7 py-2 font-medium rounded-md hover:bg-red-500 hover:text-red-50 duration-300 ">
            Add to cart
          </button>
        </div>
      </div>
